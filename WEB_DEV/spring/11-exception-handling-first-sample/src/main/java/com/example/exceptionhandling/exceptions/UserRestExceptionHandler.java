...
public class UserRestExceptionHandler {
    ...
    If you want to add multiple exeptions add "{}" @ExceptionHandler({IOException.class, SQLException.class}).
    ...
    */
    ...
    public ResponseEntity<UserErrorDTO> handleUserNotFoundException(UserNotFoundException exc) {
        // Creating an ApiErrorDTO using the createErrorResponse method.
        UserErrorDTO error = createErrorResponse(HttpStatus.NOT_FOUND,
                                                exc.getMessage(),
    ...
    public ResponseEntity<UserErrorDTO> handleGeneralException(Exception exc) {
        // Creating an ApiErrorDTO for the generic exception.
        UserErrorDTO error = createErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR,
    ...
    private UserErrorDTO createErrorResponse(HttpStatus status, String message, Long timeStamp) {
